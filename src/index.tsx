...
class RichMarkdownEditor extends React.PureComponent<Props, State> {
  ...
  createNodeViews() {
    return this.extensions.extensions.reduce((nodeViews, extension) => {
      let nodeView: NodeViewConstructor | null = null
      if (extension instanceof ReactNode) {
        nodeView = (node, view, getPos, decorations) => {
      ...
      } else if (extension instanceof NodeViewNode) {
        nodeView = extension.getNodeViewConstructor({ editor: this })
      }
      if (nodeView) {
        nodeViews[extension.name] = nodeView
      }
      return nodeViews
    }, {})
  }
    ...
    const view = new EditorView(this.element, {
      ...
      dispatchTransaction: transaction => {
        ...
        if (
          ...
          (!this.props.readOnly ||
            this.view.state.doc.attrs.conflictAction ||
